...
Summary: Simple HTML5 WAR-based application allowing login/logout and displaying full name of the user obtained from the token.   
Target Product: RH-SSO  
Source: <https://github.com/keycloak/rh-sso-quickstarts>  

What is it?
-----------
Simple HTML5 WAR-based application allowing login/logout and displaying full name of the user obtained from the token.
...
You can run example with the following URL: <http://localhost:8080/jboss-war-app-profile-html5>
