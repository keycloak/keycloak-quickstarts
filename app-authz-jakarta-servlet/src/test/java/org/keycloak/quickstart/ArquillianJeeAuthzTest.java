...
public class ArquillianJeeAuthzTest {
    ...
    public static Archive createTestArchive() throws IOException {
        return ShrinkWrap.create(ZipImporter.class, "app-authz-jakarta-servlet.war").importFrom(
                new File("target/app-authz-jakarta-servlet.war")).as(WebArchive.class)
                .addAsWebInfResource("oidc.json")
                .addAsWebInfResource("policy-enforcer.json");
    }
