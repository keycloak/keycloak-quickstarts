...
public class ArquillianTest {
    ...
    @Deployment(name = "app-profile-saml", order = 2, testable = false)
    public static Archive<?> createTestArchive2() throws IOException {
        return ShrinkWrap.create(WebArchive.class, "app-profile-saml.war")
                ...
                .addAsWebInfResource(new File("config", "keycloak-saml.xml"))
    ...
    @ArquillianResource
    @OperateOnDeployment("app-profile-saml")
    ...
    public void testLogin() throws InterruptedException {
        try {
            ...
            assertEquals(profilePage.getUsername(), "user");
